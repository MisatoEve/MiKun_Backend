...
import { 
    ...
    generateInputError, 
    generateNoLoggedUser 
} from '../repository/errors/info.js';
import { 
    CartsService, 
    ProductsService, 
    UsersService 
...
export const cartById = async (req, res) => {
    try {
        ...
        //▼Lógica que pasará el importe total del carrito
    ...
    try {
        ...
        const mailOptions = {
            ...
            html:   `<main class="container m-3 text-center" style='background-color: #B9CDDA;">
                        ...
                        <p class="m-3">If you wanna keep looking the website, be my guest!!! Click <a href="https://mikunbackend-production.up.railway.app/home">here</a>!
                    </main>`
        }
